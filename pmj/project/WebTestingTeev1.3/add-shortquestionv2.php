...
if($_POST) {
	...
	if($msg=="") {
		...
		$sql = "REPLACE INTO question VALUES('', '$subject_id', '$q', '$f', '1')";
...
<form method="post" enctype="multipart/form-data">
    ...
    <label>Fill your answer:</label><input type="text" name="choice[1]" maxlength="250"><input type="radio" name="answer" value="1">(Confirm)<br>

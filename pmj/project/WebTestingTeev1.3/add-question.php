...
if($_POST) {
	...
	if($msg=="") {
		...
		$sql = "REPLACE INTO question VALUES('', '$subject_id', '$q', '$f', null)";
		if(@mysqli_query($link, $sql)) {
			...
			for($i = 1; $i <= count($_POST['choice']); $i++) {
				...
				$sql = "REPLACE INTO choice VALUES('', '$question_id', '$ch_text', '$answer')";
...
<form method="post" enctype="multipart/form-data">
    ...
    <label>Choices and answer:</label><input type="text" name="choice[1]" maxlength="250"><input type="radio" name="answer" value="1">(Answer)<br>
    <label></label><input type="text" name="choice[2]" maxlength="250"><input type="radio" name="answer" value="2">(Answer)<br>
    <label></label><input type="text" name="choice[3]" maxlength="250"><input type="radio" name="answer" value="3">(Answer)<br>
    <label></label><input type="text" name="choice[4]" maxlength="250"><input type="radio" name="answer" value="4">(Answer)<br>
